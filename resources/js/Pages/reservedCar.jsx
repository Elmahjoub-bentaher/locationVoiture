...
const ReservedCar = () => {
    const [selected, setSelected] = useState("marque");
    const [selected1, setSelected1] = useState("model");
    const [selected2, setSelected2] = useState("année");
    ...
    useEffect(() => {
        const filteredVoitures = voitures.filter((voiture) => {
            ...
            const excludeByBrand =
                selected === "marque" || voiture.marque == selected;

            const excludeByModel =
                selected1 === "model" || voiture.modèle == selected1;

            const excludeByYear =
                selected2 === "année" || voiture.année == selected2;
